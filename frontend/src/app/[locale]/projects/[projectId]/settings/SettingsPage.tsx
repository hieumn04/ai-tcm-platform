  ...
  useEffect(() => {
    async function fetchDataEffect() {
      ...
      try {
        ...
        if (data.userId) {
          const ownerData = await findUser(
            context.token.access_token,
            data.userId,
          )
          if (ownerData) {
            ...
            console.error('Failed to fetch project owner data')
          }
        } else {
      ...
      <div className="w-full p-3 flex items-center justify-between">
        ...
        <div>
          <Button
            ...
            color="danger"
            isDisabled={
              !(context.isProjectOwner(Number(projectId)) || context.isAdmin())
            }
            ...
            <TableRow key="project-owner">
              ...
              <TableCell>
                <div className="flex gap-2 items-center">
                  ...
                  />
                  <p className="">{owner?.username || 'Unknown'}</p>
                </div>
              </TableCell>
            </TableRow>
