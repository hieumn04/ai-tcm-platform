...
const testRunCaseStatus: TestRunCaseStatusType[] = [
  ...
  { uid: 'pending', color: 'info', chartColor: '#1e90ff' },
];

const priorities: PriorityType[] = [
  { uid: 'critical', color: '#ff6961', chartColor: '#ff6961' },
  { uid: 'high', color: '#ffb347', chartColor: '#ffb347' },
  { uid: 'medium', color: '#fdfd96', chartColor: '#fdfd96' },
  { uid: 'low', color: '#77dd77', chartColor: '#77dd77' },
];
