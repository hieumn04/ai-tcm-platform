...
export default function ProjectDialog({
  ...
  const [isProjectPublic, setIsProjectPublic] = useState(
    editingProject ? editingProject.isPublic : true,
  )
      ...
      <ModalContent>
        ...
        <ModalBody>
          ...
          <div className="text-small text-default-500">
            {projectDialogMessages.ifYouMakePublic}
          </div>
        </ModalBody>
        <ModalFooter>
          ...
          <Button color="primary" onClick={validate}>
            {editingProject
              ? projectDialogMessages.update
              : projectDialogMessages.create}
          </Button>
        </ModalFooter>
      </ModalContent>
    </Modal>
